...
public class MainMind extends Activity {
    ...
    private static final String MAIN_ACTIVITY_TAG = "Mind_MainActivity";

    private WebView mWebView;
    private long mLastBackPress;
    private static final long mBackPressThreshold = 3500;
    private static final String IS_FULLSCREEN_PREF = "is_fullscreen_pref1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bannerads_load(MainMind.this, relativeLayout, id);
...
//        }
        ...
        if (savedInstanceState != null) {
            ...
            mWebView.loadUrl("file:///android_asset/linkup/index.html?lang=" + Locale.getDefault().getLanguage());
        }
